...
from scripts.validate_release import validate_release_manifest, validate_repository_contract, validate_sha256, validate_status_index


def execution() -> dict:
    return {
        "workflow_name": "CI", "workflow_run_id": "123", "workflow_run_attempt": "1",
        "event_name": "push", "source_sha": "abc123",
...
def manifest_payload() -> dict:
    return {
        "schema_version": 1, "release_class": "repository", "git_commit": "abc123", "git_branch": "main",
        "generated_at_utc": "2026-09-03T12:00:00Z", "python": "3.12.0", "execution": execution(),
